...
7. **النافذة العائمة**: ⚙️ ← منح صلاحية «العرض فوق التطبيقات» ← إظهار الفقاعة.
8. **المساعد الافتراضي**: ⚙️ ← فتح إعدادات المساعد ← اختر «وكيل الأتمتة»
   (VoiceInteractionService — استدعاء من زر المنزل / إيماءة المساعد).
